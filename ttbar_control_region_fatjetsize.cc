...
int ttbar_control_region_fatjetsize(){
        gStyle->SetOptStat(0);
	...
	vector<LV> *fatjetp4=0;
        ...
        TH1F *hdata=new TH1F("",";N_{fatjet};N/Events",NBIN,INF,SUP);
